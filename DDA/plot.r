...
METRICS_DIR <- if(ANALYSIS_MODE == "MaxQuant") "metrics_Maxquant" else "metrics_FragPipe"
PLOT_DIR <- if(ANALYSIS_MODE == "MaxQuant") "Plot_files/MaxQuant" else "Plot_files/FragPipe"
