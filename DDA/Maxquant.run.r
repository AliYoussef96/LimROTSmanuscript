...
for(i.exp in all.exp){
    ...
    for(i.Contrasts in Contrasts){
       ...
       if(any(is.na(df.temp))){
        ...
        saveRDS(se, paste0("Maxquant_results/", "LimROTS_" , i.exp , "_" , i.Contrasts, ".rds"))
        ...
        saveRDS(rots_results, paste0("Maxquant_results/", "ROTS_" , i.exp , "_" , i.Contrasts, ".rds"))
        ...
        saveRDS(limma.results, paste0("Maxquant_results/", "Limma_" , i.exp , "_" , i.Contrasts, ".rds"))
        ...
        saveRDS(SAM.results, paste0("Maxquant_results/", "SAM_" , i.exp , "_" , i.Contrasts, ".rds"))
        remove(SAM.results)
        gc()
        ...
        saveRDS(i.test.result, paste0("Maxquant_results/", "ttest_" , i.exp , "_" , i.Contrasts, ".rds"))
        ...
        anova.results = data.frame(row.names(df.temp),
                                   ...
                                   P.Value=ord.p, 
                                   adj.P.Val = ord.q)
        saveRDS(anova.results, paste0("Maxquant_results/", "ANOVA_" , i.exp , "_" , i.Contrasts, ".rds"))
