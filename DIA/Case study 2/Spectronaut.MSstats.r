...
exp.mar1 <- read.csv("../HEof_n600_DIA/Spectronaut/report.tsv", sep = "\t")
annot.mar1 <- read.csv("../Spectronaut/HEof_n600_DIA_Spectronaut_design_msstats.tsv", sep = "\t")
...
exp.mar2 <- read.csv("../HEof_w600_DIA/Spectronaut/report.tsv", sep = "\t")
annot.mar2 <- read.csv("../Spectronaut/HEof_w600_DIA_Spectronaut_design_msstats.tsv", sep = "\t")
...
raw <- SpectronauttoMSstatsFormat(
    annotation =annot,
    input=exp)    
