...
for(i.exp in all.exp){
    ...
    exp.mar <- read.csv(paste0("../Spectronaut/", i.exp , "_LFQ_Spectronaut_dlfq_pro_intensity.tsv"), sep = "\t")
    design <- read.csv(paste0("../Spectronaut/", i.exp , "_LFQ_Spectronaut_design.tsv"), sep = "\t")
