...
for(i.exp in all.exp){
    ...
    exp.mar <- read.csv(paste0("../Spectronaut/", i.exp , "_DIA_spt_dlfq.tsv"), sep = "\t")
    design <- read.csv(paste0("../Spectronaut/", i.exp , "_DIA_spt_design.tsv"), sep = "\t")
    ...
    for(i.Contrasts in Contrasts){
       ...
       if(any(is.na(df.temp))){
        ...
        saveRDS(se, paste0("spectronaut_resutls/", "LimROTS_" , i.exp , "_" , i.Contrasts, ".rds"))
        ...
        saveRDS(rots_results, paste0("spectronaut_resutls/", "ROTS_" , i.exp , "_" , i.Contrasts, ".rds"))
...
for(i.exp in all.exp){
    ...
    for(i.Contrasts in Contrasts){
        ...
        saveRDS(limma.results, paste0("spectronaut_resutls/", "Limma_" , i.exp , "_" , i.Contrasts, ".rds"))
        ...
        saveRDS(SAM.results, paste0("spectronaut_resutls/", "SAM_" , i.exp , "_" , i.Contrasts, ".rds"))
        remove(SAM.results)
        gc()
        ...
        saveRDS(i.test.result, paste0("spectronaut_resutls/", "ttest_" , i.exp , "_" , i.Contrasts, ".rds"))
